...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . gjrlwxjmfp
[ 0 ] ) , 0 , 0 , 34 } , { ( char_T * ) ( & rtDW . ek1sjukwvj ) , 0 , 0 , 5 }
, { ( char_T * ) ( & rtDW . guuazjd4zv . LoggedData ) , 11 , 0 , 14 } , { (
char_T * ) ( & rtDW . kvbwvy2tzn ) , 10 , 0 , 3 } , { ( char_T * ) ( & rtDW .
mnxor4yhos ) , 8 , 0 , 1 } } ; static DataTypeTransitionTable rtBTransTable =
{ 5U , rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { {
( char_T * ) ( & rtP . Integrator_IC [ 0 ] ) , 0 , 0 , 21 } } ; static
