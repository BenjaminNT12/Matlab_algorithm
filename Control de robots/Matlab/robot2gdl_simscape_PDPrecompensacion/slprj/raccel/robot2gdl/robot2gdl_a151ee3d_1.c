...
robot2gdl_a151ee3d_1_NeDaePrivateData_create ( NeDaePrivateData * smData ) ;
void robot2gdl_a151ee3d_1_dae ( NeDae * * dae , const NeModelParameters *
...
robot2gdl_a151ee3d_1_NeDaePrivateData_create ( smData ) ; * dae =
