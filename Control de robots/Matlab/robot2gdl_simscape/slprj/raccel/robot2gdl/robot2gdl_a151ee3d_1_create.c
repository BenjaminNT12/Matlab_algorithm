...
robot2gdl_a151ee3d_1_assertData [ ] ; extern const NeZCData
robot2gdl_a151ee3d_1_ZCData [ ] ; void
robot2gdl_a151ee3d_1_computeRuntimeParameters ( const double *
runtimeRootVariables , double * runtimeParameters ) ; void
robot2gdl_a151ee3d_1_validateRuntimeParameters ( const double *
runtimeParameters , int32_T * assertSatisfactionFlags ) ; void
robot2gdl_a151ee3d_1_computeAsmRuntimeDerivedValues ( const double *
runtimeParameters , RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle )
; void robot2gdl_a151ee3d_1_computeSimRuntimeDerivedValues ( const double *
runtimeParameters , RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle )
; void robot2gdl_a151ee3d_1_initializeGeometries ( const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle ) ; PmfMessageId
robot2gdl_a151ee3d_1_compDerivs ( const RuntimeDerivedValuesBundle * , const
int * , const double * , const int * , const double * , const double * ,
const double * , const double * , double * , double * , NeuDiagnosticManager
* neDiagMgr ) ; PmfMessageId robot2gdl_a151ee3d_1_numJacPerturbLoBounds (
...
robot2gdl_a151ee3d_1_numJacPerturbHiBounds ( const RuntimeDerivedValuesBundle
...
robot2gdl_a151ee3d_1_checkDynamics ( const RuntimeDerivedValuesBundle * ,
const double * , const double * , const double * , const double * , const
double * , const int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId robot2gdl_a151ee3d_1_compOutputsDyn ( const
...
PmfMessageId robot2gdl_a151ee3d_1_compOutputsKin ( const
RuntimeDerivedValuesBundle * , const double * , const int * , const double *
, const double * , const double * , const double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
robot2gdl_a151ee3d_1_compOutputs ( const RuntimeDerivedValuesBundle * , const
double * , const int * , const double * , const double * , const double * ,
const double * , double * , NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
robot2gdl_a151ee3d_1_computeAsmModeVector ( const double * , const double * ,
const double * , int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId robot2gdl_a151ee3d_1_computeSimModeVector ( const double * ,
const double * , const double * , int * , double * , NeuDiagnosticManager *
neDiagMgr ) ; PmfMessageId robot2gdl_a151ee3d_1_computeZeroCrossings ( const
RuntimeDerivedValuesBundle * , const double * , const double * , const double
* , const double * , const double * , double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
robot2gdl_a151ee3d_1_recordLog ( const RuntimeDerivedValuesBundle * , const
int * , const double * , const int * , const double * , const double * ,
...
robot2gdl_a151ee3d_1_resetAsmStateVector ( const void * mech , double *
stateVector ) ; void robot2gdl_a151ee3d_1_resetSimStateVector ( const void *
mech , double * stateVector ) ; void
robot2gdl_a151ee3d_1_initializeTrackedAngleState ( const void * mech , const
...
robot2gdl_a151ee3d_1_computeDiscreteState ( const void * mech , const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , double *
stateVector ) ; void robot2gdl_a151ee3d_1_adjustPosition ( const void * mech
...
error ) ; size_t robot2gdl_a151ee3d_1_computeAssemblyJacobian ( const void *
...
) ; size_t robot2gdl_a151ee3d_1_computeFullAssemblyJacobian ( const void *
...
double * J ) ; boolean_T robot2gdl_a151ee3d_1_isInKinematicSingularity (
const void * mech , const RuntimeDerivedValuesBundle *
runtimeDerivedValuesBundle , size_t constraintIdx , const int * modeVector ,
const double * motionData ) ; void robot2gdl_a151ee3d_1_convertStateVector (
...
double * simStateVector ) ; void robot2gdl_a151ee3d_1_constructStateVector (
const void * mech , const double * solverStateVector , const double * u ,
const double * uDot , const double * discreteStateVector , double *
fullStateVector ) ; void robot2gdl_a151ee3d_1_extractSolverStateVector (
const void * mech , const double * fullStateVector , double *
solverStateVector ) ; boolean_T robot2gdl_a151ee3d_1_isPositionViolation (
const void * mech , const RuntimeDerivedValuesBundle *
...
modeVector ) ; PmfMessageId robot2gdl_a151ee3d_1_projectStateSim ( const void
...
robot2gdl_a151ee3d_1_computeConstraintError ( const void * mech , const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , const double *
stateVector , const int * modeVector , double * error ) ; void
robot2gdl_a151ee3d_1_resetModeVector ( const void * mech , int * modeVector )
; boolean_T robot2gdl_a151ee3d_1_hasJointDisToNormModeChange ( const void *
...
neDiagMgr ) ; void robot2gdl_a151ee3d_1_onModeChangedCutJoints ( const void *
mech , const int * prevModeVector , const int * modeVector , double *
stateVector ) ; PmfMessageId robot2gdl_a151ee3d_1_assemble ( const double * u
...
return ; robot2gdl_a151ee3d_1_computeRuntimeParameters ( runtimeRootVariables
, smData -> mRuntimeParameterScalars . mX ) ;
robot2gdl_a151ee3d_1_computeAsmRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
mAsmRuntimeDerivedValuesBundle ) ;
robot2gdl_a151ee3d_1_computeSimRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
mSimRuntimeDerivedValuesBundle ) ; robot2gdl_a151ee3d_1_initializeGeometries
...
; robot2gdl_a151ee3d_1_validateRuntimeParameters ( runtimeParams ,
...
robot2gdl_a151ee3d_1_compDerivs ( & smData -> mSimRuntimeDerivedValuesBundle
...
errorResult = 0.0 ; errorId = robot2gdl_a151ee3d_1_numJacPerturbLoBounds ( &
...
robot2gdl_a151ee3d_1_numJacPerturbHiBounds ( & smData ->
...
errorId = robot2gdl_a151ee3d_1_computeSimModeVector ( systemInput -> mU . mX
...
robot2gdl_a151ee3d_1_computeZeroCrossings ( & smData ->
...
robot2gdl_a151ee3d_1_constructStateVector ( NULL , systemInput -> mX . mX ,
systemInput -> mU . mX , systemInput -> mU . mX + 2 , systemInput -> mD . mX
, fullStateVector ) ; errorId = robot2gdl_a151ee3d_1_recordLog ( & smData ->
mSimRuntimeDerivedValuesBundle , smData -> mSimulationDelegate .
mRunTimeEnabledEquations . mValues , fullStateVector , systemInput -> mM . mX
, systemInput -> mU . mX , systemInput -> mU . mX + 2 , systemInput -> mV .
mX + 2 , output -> mX , & errorResult , neDiagMgr ) ; return errorId ; }
...
robot2gdl_a151ee3d_1_checkDynamics ( & smData ->
mSimRuntimeDerivedValuesBundle , systemInput -> mX . mX , systemInput -> mU .
mX , systemInput -> mU . mX + 2 , systemInput -> mV . mX + 2 , systemInput ->
...
robot2gdl_a151ee3d_1_computeSimModeVector ( systemInput -> mU . mX ,
...
robot2gdl_a151ee3d_1_computeAsmModeVector ( systemInput -> mU . mX ,
...
#if 0
robot2gdl_a151ee3d_1_checkTargets ( & smData ->
...
mStateVectorSize = 0 ; smData -> mFullStateVectorSize = 4 ; smData ->
...
; const int32_T * stateVectorMap = NULL ; const CTarget targets [ 8 ] = { { 0
, 33 , 0 , false , 0 , 1 , "deg" , false , true , + 1.000000000000000000e+00
, false , 1 , { - 3.545016258398634573e-02 , + 0.000000000000000000e+00 , +
...
1 , { + 2.231796347723790600e-03 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
...
pm_create_real_vector_fields ( & smData -> mAssemblyFullStateVector , 4 ,
alloc ) ; checkMemAllocStatus ( status ) ; status =
pm_create_real_vector_fields ( & smData -> mSimulationFullStateVector , 4 ,
alloc ) ; checkMemAllocStatus ( status ) ; status =
...
mNumInputMotionPrimitives = 2 ; PM_ALLOCATE_ARRAY ( smData -> mTargets ,
...
robot2gdl_a151ee3d_1_assertData ; size_t i ; PM_ALLOCATE_ARRAY ( smData ->
...
robot2gdl_a151ee3d_1_ZCData ; size_t i ; PM_ALLOCATE_ARRAY ( smData ->
...
) { const char * inputPortPaths [ 2 ] = { "Revolute.qi" , "Revolute1.qi" } ;
const char * inputUnits [ 2 ] = { "rad" , "rad" } ; const SizePair
inputDimensions [ 2 ] = { { 1 , 1 } , { 1 , 1 } } ; const char * *
outputPortPaths = NULL ; const char * * outputUnits = NULL ; const SizePair *
outputDimensions = NULL ; initIoInfoHelper ( 2 , inputPortPaths , inputUnits
, inputDimensions , true , smData ) ; initIoInfoHelper ( 0 , outputPortPaths
...
jointToStageIdx [ 2 ] = { { 33 , 1 } , { 34 , 0 } } ; const size_t
primitiveIndices [ 2 + 1 ] = { 0 , 1 , 2 } ; const SmSizePair stateOffsets [
2 ] = { { 0 , 1 } , { 2 , 3 } } ; const SmSizePair dofOffsets [ 2 ] = { { 0 ,
1 } , { 1 , 2 } } ; const size_t * flexibleStages = NULL ; const size_t
remodIndices [ 2 ] = { 0 , 2 } ; const size_t * equationsPerConstraint = NULL
; const int32_T * hasAllVelocityDisabledEquations = NULL ; const int32_T *
runtimeEnabledEquations = NULL ; const size_t dofToVelSlot [ 2 ] = { 1 , 3 }
; const size_t * constraintDofs = NULL ; const size_t constraintDofOffsets [
0 + 1 ] = { 0 } ; const size_t Jm = 0 ; const size_t Jn = 2 ; SmSizePair
...
1.000000000000000062e-09 ; delegate -> mTreeJointDof = 2 ; delegate -> mDof =
2 ; delegate -> mStateSize = 4 ; delegate -> mContinuousStateSize = 4 ;
...
( & scratchpad -> mPosRequired , 2 ) ; sm_core_SmBoundedSet_create ( &
scratchpad -> mPosDesired , 2 ) ; sm_core_SmBoundedSet_create ( & scratchpad
-> mPosSuggested , 2 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mPosFree , 2 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mPosNonRequired , 2 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mPosSuggAndFree , 2 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mVelRequired , 2 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mVelDesired , 2 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mVelSuggested , 2 ) ; sm_core_SmBoundedSet_create ( & scratchpad -> mVelFree
, 2 ) ; sm_core_SmBoundedSet_create ( & scratchpad -> mVelNonRequired , 2 ) ;
...
mPartiallyPosTargetedPrims , 2 , & zeroSizePair ) ;
sm_core_SmSizePairVector_create ( & scratchpad -> mPartiallyVelTargetedPrims
, 2 , & zeroSizePair ) ; sm_core_SmSizeTVector_create ( & scratchpad ->
mPosPartialTypes , 2 , 0 ) ; sm_core_SmSizeTVector_create ( & scratchpad ->
mVelPartialTypes , 2 , 0 ) ; sm_core_SmSizeTVector_create ( & scratchpad ->
mPartiallyActivePrims , 2 , 0 ) ; sm_core_SmSizePairVector_create ( &
...
scratchpad -> mInitialState , 4 , 0.0 ) ; sm_core_SmRealVector_create ( &
scratchpad -> mStartState , 4 , 0.0 ) ; sm_core_SmRealVector_create ( &
scratchpad -> mTestState , 4 , 0.0 ) ; sm_core_SmRealVector_create ( &
scratchpad -> mFullStateVector , 4 , 0.0 ) ; sm_core_SmIntVector_create ( &
...
mSvdWork , 9 , 0.0 ) ; sm_core_SmRealVector_create ( & scratchpad ->
...
) ; sm_core_SmRealVector_create ( & scratchpad -> mActiveDofVelsVect , 2 ,
0.0 ) ; sm_core_SmRealVector_create ( & scratchpad -> mVelSystemRhs , Jm ,
0.0 ) ; sm_core_SmRealVector_create ( & scratchpad -> mMotionData , 26 , 0.0
) ; delegate -> mSetTargets = robot2gdl_a151ee3d_1_setTargets ; delegate ->
mResetStateVector = robot2gdl_a151ee3d_1_resetAsmStateVector ; delegate ->
mInitializeTrackedAngleState =
robot2gdl_a151ee3d_1_initializeTrackedAngleState ; delegate ->
mComputeDiscreteState = robot2gdl_a151ee3d_1_computeDiscreteState ; delegate
-> mAdjustPosition = robot2gdl_a151ee3d_1_adjustPosition ; delegate ->
mPerturbJointPrimitiveState =
robot2gdl_a151ee3d_1_perturbAsmJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = NULL ; delegate -> mComputePosDofBlendMatrix =
robot2gdl_a151ee3d_1_computePosDofBlendMatrix ; delegate ->
mComputeVelDofBlendMatrix = robot2gdl_a151ee3d_1_computeVelDofBlendMatrix ;
delegate -> mProjectPartiallyTargetedPos =
robot2gdl_a151ee3d_1_projectPartiallyTargetedPos ; delegate ->
mPropagateMotion = robot2gdl_a151ee3d_1_propagateMotion ; delegate ->
mComputeAssemblyError = robot2gdl_a151ee3d_1_computeAssemblyError ; delegate
-> mComputeAssemblyJacobian = robot2gdl_a151ee3d_1_computeAssemblyJacobian ;
delegate -> mComputeFullAssemblyJacobian =
robot2gdl_a151ee3d_1_computeFullAssemblyJacobian ; delegate ->
mIsInKinematicSingularity = robot2gdl_a151ee3d_1_isInKinematicSingularity ;
delegate -> mConvertStateVector = robot2gdl_a151ee3d_1_convertStateVector ;
...
= NULL ; const SmSizePair jointToStageIdx [ 2 ] = { { 33 , 1 } , { 34 , 0 } }
; const size_t primitiveIndices [ 2 + 1 ] = { 0 , 1 , 2 } ; const SmSizePair
stateOffsets [ 2 ] = { { 0 , 1 } , { 2 , 3 } } ; const SmSizePair dofOffsets
[ 2 ] = { { 0 , 1 } , { 1 , 2 } } ; const size_t * flexibleStages = NULL ;
...
robot2gdl_a151ee3d_1_resetSimStateVector ; delegate ->
mInitializeTrackedAngleState = NULL ; delegate -> mComputeDiscreteState =
NULL ; delegate -> mAdjustPosition = NULL ; delegate ->
mPerturbJointPrimitiveState =
robot2gdl_a151ee3d_1_perturbSimJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = robot2gdl_a151ee3d_1_perturbFlexibleBodyState ;
...
delegate -> mConstructStateVector = robot2gdl_a151ee3d_1_constructStateVector
; delegate -> mExtractSolverStateVector =
robot2gdl_a151ee3d_1_extractSolverStateVector ; delegate ->
mIsPositionViolation = robot2gdl_a151ee3d_1_isPositionViolation ; delegate ->
mIsVelocityViolation = robot2gdl_a151ee3d_1_isVelocityViolation ; delegate ->
mProjectStateSim = robot2gdl_a151ee3d_1_projectStateSim ; delegate ->
mComputeConstraintError = robot2gdl_a151ee3d_1_computeConstraintError ;
delegate -> mResetModeVector = robot2gdl_a151ee3d_1_resetModeVector ;
delegate -> mHasJointDisToNormModeChange =
robot2gdl_a151ee3d_1_hasJointDisToNormModeChange ; delegate ->
mPerformJointDisToNormModeChange =
robot2gdl_a151ee3d_1_performJointDisToNormModeChange ; delegate ->
mOnModeChangedCutJoints = robot2gdl_a151ee3d_1_onModeChangedCutJoints ;
delegate -> mMech = NULL ; } static void initMechanismDelegates (
NeDaePrivateData * smData ) { PmAllocator * alloc = pm_default_allocator ( )
; const int32_T motionInputOffsets [ 2 ] = { 1 , 0 } ; int_T status = 0 ;
...
( smData -> mMotionInputOffsets . mX , motionInputOffsets , 2 * sizeof (
...
} void robot2gdl_a151ee3d_1_NeDaePrivateData_create ( NeDaePrivateData *
