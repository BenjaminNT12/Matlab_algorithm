...
h1 = animatedline('Color','#0072BD',"Linewidth",1.2);
h2 = animatedline('Color','#D95319','LineWidth',1.2);
h3 = animatedline('Color','#EDB120','LineWidth',1.2);
h4 = animatedline('Color','#7E2F8E','LineWidth',1.2);
h5 = animatedline('Color','#77AC30','LineWidth',1.2);
h6 = animatedline('Color','#4DBEEE','LineWidth',1.2);
h7 = animatedline('Color','#A2142F','LineWidth',1.2);
h8 = animatedline('Color','#FF0000','LineWidth',1.2);

h9 = animatedline('Color','#0072BD',"Linewidth",1.2);
h10 = animatedline('Color','#D95319','LineWidth',1.2);
h11 = animatedline('Color','#EDB120','LineWidth',1.2);
h12 = animatedline('Color','#7E2F8E','LineWidth',1.2);
h13 = animatedline('Color','#77AC30','LineWidth',1.2);
h14 = animatedline('Color','#4DBEEE','LineWidth',1.2);
h15 = animatedline('Color','#A2142F','LineWidth',1.2);
h16 = animatedline('Color','#FF0000','LineWidth',1.2);

h17 = animatedline('Color','#7E2F8E','LineWidth',1.2);
h18 = animatedline('Color','#77AC30','LineWidth',1.2);
