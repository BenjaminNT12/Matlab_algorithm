...
% MATRIZ DE RIGIDEZ DEBE CAMBIARSE DEPENDIENDO DE LA FORMACION DESEADA    
    ...
    R2 = [                          zeros(1,2),  (q(k, 2*2-1:2*2) - q(k, 3*2-1:3*2)),  -(q(k, 2*2-1:2*2) - q(k, 3*2-1:3*2)),                            zeros(1,2),                            zeros(1,2)];
    R3 = [                          zeros(1,2),                           zeros(1,2),   (q(k, 3*2-1:3*2) - q(k, 4*2-1:4*2)),  -(q(k, 3*2-1:3*2) - q(k, 4*2-1:4*2)),                            zeros(1,2)];
    R4 = [ (q(k, 1*2-1:1*2) - q(k, 4*2-1:4*2)),                           zeros(1,2),                            zeros(1,2),  -(q(k, 1*2-1:1*2) - q(k, 4*2-1:4*2)),                            zeros(1,2)];
    R5 = [                          zeros(1,2),  (q(k, 2*2-1:2*2) - q(k, 4*2-1:4*2)),                            zeros(1,2),  -(q(k, 2*2-1:2*2) - q(k, 4*2-1:4*2)),                            zeros(1,2)];
    R6 = [                          zeros(1,2),                           zeros(1,2),                            zeros(1,2),   (q(k, 4*2-1:4*2) - q(k, 5*2-1:5*2)),  -(q(k, 4*2-1:4*2) - q(k, 5*2-1:5*2))];
