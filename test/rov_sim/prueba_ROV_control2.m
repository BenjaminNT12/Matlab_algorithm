...
%% Referencias control actor-critico
...
X   = [x1d(1), yd(1), zd(1), phid(1), thetad(1), psid(1), 0, 0, 0, 0, 0, 0];
tau = [0; 0; 0; 0; 0; 0];
...
%% Actor-critico
   ...
   xsistema = [x; xp] ;
    ...
    Nabla_phi1=[1,0;e2,e1;0,1];   %siendo phi1=[e1;e1e2;e2];
    phi2=[e1;0;e2]; 
    %phi2=[e1;1;e2];    %%%MOVERLE A phi1 y 2, de esto depende la convergencia   
...
%save('prueba_X.mat', 'A_hat', 'C_hat', 'Au_hat', 'Cu_hat','l_hat');
% % figure(1)
...
figure(1)
subplot(3,1,1)
plot(t, x1d, 'k--', t, X(:,1), 'r' ,'LineWidth', 2.5)
set(gca, 'FontSize', 12)
legend('x_d', 'x')
...
figure(5)
subplot(211) 
plot(t(end-5000:end),e1_plot(end-5000:end))
legend('e1')
%
subplot(212)
plot(t(end-5000:end),e2_plot(end-5000:end))
legend('e2') 
hold on
