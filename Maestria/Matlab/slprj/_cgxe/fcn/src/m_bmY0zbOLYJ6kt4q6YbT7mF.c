...
static void cgxe_mdl_start(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
  *moduleInstance);
static void mw__internal__system__init__fcn(void);
static void mw__internal__call__setup(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__reset(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
...
static boolean_T j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF
  *moduleInstance);
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (int16_T (*)[2])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S, int_T tid)
{
  InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance =
    (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S)
{
  InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance =
    (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S, int_T tid)
{
  InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance =
    (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance =
    (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance =
    (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S)
{
  InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance =
    (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S)
{
  InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance =
    (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S)
{
  InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance =
    (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S)
{
  InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *moduleInstance =
    (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF *)calloc(1, sizeof
    (InstanceStruct_bmY0zbOLYJ6kt4q6YbT7mF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_bmY0zbOLYJ6kt4q6YbT7mF);
  ssSetmdlInitializeConditions(S, mdlInitialize_bmY0zbOLYJ6kt4q6YbT7mF);
  ssSetmdlUpdate(S, mdlUpdate_bmY0zbOLYJ6kt4q6YbT7mF);
  ssSetmdlTerminate(S, mdlTerminate_bmY0zbOLYJ6kt4q6YbT7mF);
  ssSetmdlEnable(S, mdlEnable_bmY0zbOLYJ6kt4q6YbT7mF);
  ssSetmdlDisable(S, mdlDisable_bmY0zbOLYJ6kt4q6YbT7mF);
...
static void mdlProcessParameters_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S)
{
}

void method_dispatcher_bmY0zbOLYJ6kt4q6YbT7mF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_bmY0zbOLYJ6kt4q6YbT7mF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_bmY0zbOLYJ6kt4q6YbT7mF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_bmY0zbOLYJ6kt4q6YbT7mF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_bmY0zbOLYJ6kt4q6YbT7mF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: bmY0zbOLYJ6kt4q6YbT7mF.\n"
...
mxArray *cgxe_bmY0zbOLYJ6kt4q6YbT7mF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_bmY0zbOLYJ6kt4q6YbT7mF_fallback_info(void)
{
