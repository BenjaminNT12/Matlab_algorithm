###########################################################################
## Makefile generated for Simulink model 'ArduinoMATLAB'. 
## 
## Makefile     : ArduinoMATLAB.mk
## Generated on : Fri Apr 13 15:41:28 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ArduinoMATLAB.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/BENJAM~1/GOOGLE~1/WAVELE~1/Matlab/ARDUIN~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = ArduinoMATLAB_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ArduinoMATLAB.elf
...
DEFINES_ = -DMODEL=ArduinoMATLAB -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=5 -DMW_PRESCALAR=64 -DMW_TIMERCOUNT=65286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=ArduinoMATLAB -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/ArduinoMATLAB_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/ArduinoMATLAB_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/ArduinoMATLAB_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
