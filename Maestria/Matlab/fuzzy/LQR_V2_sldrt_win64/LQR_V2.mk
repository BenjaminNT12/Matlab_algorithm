...
MODEL                := LQR_V2
MODULES              := LQR_V2_data.c LQR_V2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := LQR_V2.mk
...
#
MODELLIB                  := LQR_V2lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := LQR_V2_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;$(MATLAB_ROOT)/simulink/include/sf_runtime;F:/fuzzy/LQR_V2_sldrt_win64;F:/fuzzy;C:/Users/MCAC-UAEH/Desktop/LQR;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
