...
#ifndef RTW_HEADER_LQR_V2_h_
#define RTW_HEADER_LQR_V2_h_
#include <math.h>
#include <string.h>
#ifndef LQR_V2_COMMON_INCLUDES_
# define LQR_V2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* LQR_V2_COMMON_INCLUDES_ */

#include "LQR_V2_types.h"
...
typedef struct {
  ...
  real_T TransferFcn2;                 /* '<S2>/Transfer Fcn2' */
  ...
  real_T SumofElements4;               /* '<S3>/Sum of Elements4' */
  real_T Derivative2;                  /* '<S2>/Derivative2' */
  real_T TransferFcn6;                 /* '<S2>/Transfer Fcn6' */
  real_T Add;                          /* '<S2>/Add' */
  real_T SumofElements5;               /* '<S2>/Sum of Elements5' */
  real_T TransferFcn5;                 /* '<S2>/Transfer Fcn5' */
  real_T Derivative1;                  /* '<S2>/Derivative1' */
  real_T Derivative3;                  /* '<S2>/Derivative3' */
  B_IfActionSubsystem_LQR_V2_T IfActionSubsystem1;/* '<S5>/If Action Subsystem1' */
  B_IfActionSubsystem_LQR_V2_T IfActionSubsystem;/* '<S5>/If Action Subsystem' */
} B_LQR_V2_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T TimeStampA;                   /* '<S2>/Derivative2' */
  real_T LastUAtTimeA;                 /* '<S2>/Derivative2' */
  real_T TimeStampB;                   /* '<S2>/Derivative2' */
  real_T LastUAtTimeB;                 /* '<S2>/Derivative2' */
  real_T TimeStampA_f;                 /* '<S2>/Derivative1' */
  real_T LastUAtTimeA_f;               /* '<S2>/Derivative1' */
  real_T TimeStampB_p;                 /* '<S2>/Derivative1' */
  real_T LastUAtTimeB_d;               /* '<S2>/Derivative1' */
  real_T TimeStampA_k;                 /* '<S2>/Derivative3' */
  real_T LastUAtTimeA_m;               /* '<S2>/Derivative3' */
  real_T TimeStampB_i;                 /* '<S2>/Derivative3' */
  ...
  struct {
    void *LoggedData;
  } ToWorkspace1_PWORK_k;              /* '<Root>/To Workspace1' */

  struct {
    void *LoggedData;
  } ToWorkspace2_PWORK_p;              /* '<Root>/To Workspace2' */

  struct {
    void *LoggedData;
  } ToWorkspace3_PWORK_o;              /* '<Root>/To Workspace3' */
  ...
  DW_IfActionSubsystem_LQR_V2_T IfActionSubsystem1;/* '<S5>/If Action Subsystem1' */
  DW_IfActionSubsystem_LQR_V2_T IfActionSubsystem;/* '<S5>/If Action Subsystem' */
} DW_LQR_V2_T;
...
typedef struct {
  ...
  real_T TransferFcn6_CSTATE;          /* '<S2>/Transfer Fcn6' */
...
typedef struct {
  ...
  boolean_T TransferFcn6_CSTATE;       /* '<S2>/Transfer Fcn6' */
...
#define rtB                            LQR_V2_B
#define BlockIO                        B_LQR_V2_T
#define rtX                            LQR_V2_X
#define ContinuousStates               X_LQR_V2_T
#define rtXdot                         LQR_V2_XDot
#define StateDerivatives               XDot_LQR_V2_T
#define tXdis                          LQR_V2_XDis
#define StateDisabled                  XDis_LQR_V2_T
#define rtP                            LQR_V2_P
#define Parameters                     P_LQR_V2_T
#define rtDWork                        LQR_V2_DW
#define D_Work                         DW_LQR_V2_T
...
struct P_LQR_V2_T_ {
  ...
  real_T Constant9_Value;              /* Expression: 0
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: 0.0354
                                        * Referenced by: '<S2>/Constant'
                                        */
  real_T Constant1_Value;              /* Expression: 0
                                        * Referenced by: '<Root>/Constant1'
                                        */
  real_T SignalGenerator1_Amplitude;   /* Expression: 0.01
                                        * Referenced by: '<Root>/Signal Generator1'
                                        */
  real_T SignalGenerator1_Frequency;   /* Expression: 1.5
                                        * Referenced by: '<Root>/Signal Generator1'
                                        */
  ...
  real_T Constant_Value_b;             /* Expression: 0
                                        ...
                                        */
  real_T SignalGenerator_Amplitude;    /* Expression: 0.1
  ...
  real_T Constant6_Value;              /* Expression: 4.5
                                        ...
                                        */
  real_T Saturation_UpperSat_k;        /* Expression: 12
                                        * Referenced by: '<S2>/Saturation'
                                        */
  real_T Saturation_LowerSat_d;        /* Expression: -12
                                        * Referenced by: '<S2>/Saturation'
                                        */
  ...
  real_T Constant8_Value;              /* Expression: 0
                                        ...
                                        */
  real_T in_min_Value;                 /* Expression: 0.6
                                        * Referenced by: '<S3>/in_min'
                                        */
  real_T out_max_Value;                /* Expression: 0.5
                                        * Referenced by: '<S3>/out_max'
                                        */
  real_T out_min_Value;                /* Expression: -0.5
                                        * Referenced by: '<S3>/out_min'
                                        */
  real_T in_max_Value;                 /* Expression: 5
  ...
  real_T Constant4_Value;              /* Expression: 5.0627
                                        ...
                                        */
  real_T in_min_Value_g;               /* Expression: 2.04833984375
                                        * Referenced by: '<S4>/in_min'
                                        */
  real_T out_max_Value_j;              /* Expression: 45
                                        * Referenced by: '<S4>/out_max'
                                        */
  real_T out_min_Value_f;              /* Expression: -45
                                        * Referenced by: '<S4>/out_min'
                                        */
  real_T in_max_Value_o;               /* Expression: 3.0591
                                        * Referenced by: '<S4>/in_max'
                                        */
  real_T Constant10_Value;             /* Expression: -1.61
...
extern P_LQR_V2_T LQR_V2_P;

/* Block signals (auto storage) */
extern B_LQR_V2_T LQR_V2_B;

/* Continuous states (auto storage) */
extern X_LQR_V2_T LQR_V2_X;

/* Block states (auto storage) */
extern DW_LQR_V2_T LQR_V2_DW;

/* Model entry point functions */
extern void LQR_V2_initialize(void);
extern void LQR_V2_output(void);
extern void LQR_V2_update(void);
extern void LQR_V2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern LQR_V2_rtModel *LQR_V2(void);
...
extern RT_MODEL_LQR_V2_T *const LQR_V2_M;
 ...
 * '<Root>' : 'LQR_V2'
 * '<S1>'   : 'LQR_V2/LQR'
 * '<S2>'   : 'LQR_V2/Subsystem2'
 * '<S3>'   : 'LQR_V2/Subsystem2/Mapeo1'
 * '<S4>'   : 'LQR_V2/Subsystem2/Mapeo2'
 * '<S5>'   : 'LQR_V2/Subsystem2/Subsystem'
 * '<S6>'   : 'LQR_V2/Subsystem2/Subsystem/If Action Subsystem'
 * '<S7>'   : 'LQR_V2/Subsystem2/Subsystem/If Action Subsystem1'
 */
#endif                                 /* RTW_HEADER_LQR_V2_h_ */
