...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2016a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := pendulo_fuzzy2015
MODULES              := pendulo_fuzzy2015_data.c pendulo_fuzzy2015_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := pendulo_fuzzy2015.mk
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2016a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
#
MODELLIB                  := pendulo_fuzzy2015lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := pendulo_fuzzy2015_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;$(MATLAB_ROOT)/simulink/include/sf_runtime;F:/fuzzy/pendulo_fuzzy2015_sldrt_win64;F:/fuzzy;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
